...
OG_PAGES = {
    ...
    "og-timeline.png": dict(eyebrow="The dated record · Pittsburg County, Oklahoma", title="When it actually started",
                            tagline="Money down by June 2025. Water talks in July.\nFive committee meetings before the public knew.\nEvery date pinned to a document.",
                            footer="petition.mcalester.net/timeline · Timeline"),
