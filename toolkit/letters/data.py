...
letter(1, "Board of County Commissioners and the PCDC TID Review Committee",
  ...
  [COMMS.format(who="the Board, any commissioner, the Commissioners’ office, the committee, any committee member in that capacity, or the county’s counsel"),
   ...
   "<b>The Atoka Energy Park.</b> The “Collective Commitment from Surrounding Counties to Support the Atoka Energy Park Project” that the Board approved as item 9.B on 14 July 2025 and Chairman Rogers signed that day, with everything received with it or since: the information packet, project profile, vendor list and Master Utility Service Agreement; any profit-sharing agreement, resolution, amendment or later action; and all communications with the City of Atoka, Mayor Brian Cathey, John Hardy, JRE Strategies, Prismecs USA or any other participating county about it, or about any other proposal to generate power for data centers, from 1 January 2024.",
